...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1: The number of horses per province in Canada from 1900 to 1972."}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap= "Figure 2: The number of horses in Alberta from 1900 to 1972."}
